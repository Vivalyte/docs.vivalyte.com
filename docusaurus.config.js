    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl:
            'https://github.com/ashleyvansteenacker/docs.vivalyte.com/tree/main/docs',
        },
        blog: {
          ...
          // Remove this to remove the "edit this page" links.
          editUrl:
            'https://github.com/ashleyvansteenacker/docs.vivalyte.com/tree/main/blog',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Vivalyte`,
      },
      prism: {
